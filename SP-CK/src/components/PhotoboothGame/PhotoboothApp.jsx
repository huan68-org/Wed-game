...
const PhotoBoothApp = () => {
  ...
  // --- Filter Functions ---
  const getAdvancedFilterStyle = (filter) => {
                ...
                <div className="w-full lg:w-80">
                  <div className="bg-black/20 rounded-xl p-6 border border-white/10">
                    ...
                    >
                      ...
                      {currentSlotIndex < 4 ? `Chụp Ảnh ${currentSlotIndex + 1}/4` : 'Hoàn tất!'}
                    </button>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-3 pt-4">
                        ...
                        <button
                          ...
                          className="py-3 px-4 bg-gradient-to-r from-red-600 to-pink-600 text-white font-semibold rounded-xl hover:from-red-700 hover:to-pink-700 transition-all duration-300 flex items-center justify-center gap-2"
                        >
